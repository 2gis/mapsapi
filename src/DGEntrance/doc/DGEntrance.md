...
<table>
    ...
    <tr>
        ...
        <td><code>this</code></td>
        <td>Анимировано показывает вход на карте. Если указан параметр fitBounds со значением <code>true</code>, карта автоматически подстраиваетя так, чтобы стрелка входа в здание отображалась по центру просматриваемой области карты на максимально возможном уровне масштаба. По умолчанию <code>true</code>.</td>
    </tr>
    <tr>
