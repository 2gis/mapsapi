...
Used to load and display tile layers on the map. Extends [GridLayer](/doc/maps/en/manual/other-layers#dggridlayer).
...
<table>
    ...
    <tbody>
        <tr id='tilelayer-dg-tilelayer'>
            ...
            <td>
                Instantiates a tile layer object given a <code>URL template</code> and optionally an options object.
            </td>
        </tr>
    </tbody>
</table>
...
<table id='tilelayer-options'>
    ...
    <tbody>
        ...
        <tr id='tilelayer-subdomains'>
            ...
            <td><code>&#x27;abc&#x27;</code></td>
            <td>
                Subdomains of the tile service. Can be passed in the form of one string (where each letter
        ...
        <tr id='tilelayer-detectretina'>
            ...
            <td><code>false</code></td>
            <td>
                If <code>true</code> and user is on a retina display, it will request four tiles of half
        ...
        <tr id='tilelayer-crossorigin'>
            ...
            <td><code>false</code></td>
            <td>
                If true, all tiles will have their crossOrigin attribute set to &#39;&#39;. This is needed if
...
Options inherited from [GridLayer](/doc/maps/en/manual/other-layers#gridlayer-options) <!-- TODO: include options -->


#### Events

Events inherited from [GridLayer](/doc/maps/en/manual/other-layers#gridlayer-events) <!-- TODO: include events -->
...
<table id='tilelayer-methods'>
    ...
    <tbody>
        <tr id='tilelayer-seturl'>
            ...
            <td>
                <p>Updates the layer&#39;s URL template and redraws it (unless <code>noRedraw</code>
        ...
        <tr id='tilelayer-createtile'>
            ...
            <td>
                <p>Called only internally, overrides GridLayer&#39;s
...
Layers extending [TileLayer](#dgtilelayer) might reimplement the following method.
        ...
        <tr id='tilelayer-gettileurl'>
            ...
            <td>
                <p>
                    ...
                    this function to provide custom tile URL naming schemes.
                </p>
            </td>
        </tr>
    </tbody>
...
Methods inherited from GridLayer [GridLayer](/doc/maps/en/manual/other-layers#gridlayer-methods) <!-- TODO: include methods -->
...
Used to display WMS services as tile layers on the map. Extends [TileLayer](#dgtilelayer).
...
<table>
    ...
    <tbody>
        <tr id='tilelayer-wms-dg-tilelayer-wms'>
            ...
            <td>
                Instantiates a WMS tile layer object given a base URL of the WMS service and a WMS
...
Options inherited from [TileLayer](#tilelayer-options) <!-- TODO: include options -->
...
<table>
    ...
    <tbody>
        <tr id='tilelayer-wms-setparams'>
            ...
            <td><code>this</code></td>
            <td>
                <p>Merges an object with the new parameters and re-requests tiles on the current screen
                (unless <code>noRedraw</code> was set to true).</p>
            </td>
        </tr>
    </tbody>
</table>

Methods inherited from TileLayer [TileLayer](#tilelayer-methods) <!-- TODO: include methods -->
