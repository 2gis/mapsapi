    ...
    <tbody>
        <tr id='map-prefercanvas'>
            ...
            <td>
                ...
                отрисовываться на <a href="/doc/maps/ru/manual/geometries#dgcanvas">
                <code>Canvas</code></a>. По умолчанию все экземпляры <code>Path</code>
                отрисовываются с помощью <a href="/doc/maps/ru/manual/geometries#dgsvg"><code>SVG</code></a> рендерера.
            </td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>
                Добавлен ли <a href="/doc/maps/ru/manual/controls#dgcontrolzoom">элемент управления масштабом</a>
                на карту.
            </td>
        </tr>
        <tr>
            ...
            <td><code>true</code></td>
            <td>
                Добавлена ли <a href="/doc/maps/ru/manual/controls#dgcontrolfullscreen">
    ...
    <tbody>
        ...
        <tr id='map-zoomdelta'>
            ...
            <td>
                ...
                <a href="/doc/maps/ru/manual/controls#control-zoom">элемент управления масштабом</a>.
    ...
    <tbody>
        ...
        <tr id='map-renderer'>
            ...
            <td>
                ...
                <a href="/doc/maps/ru/manual/geometries#dgsvg"><code>DG.SVG</code></a> или
                <a href="/doc/maps/ru/manual/geometries#dgcanvas"><code>DG.Canvas</code></a>
    ...
    <tbody>
        <tr id='map-scrollwheelzoom'>
            ...
            <td>
                ...
                передано значение <code>&#39;center&#39;</code>, масштаб будет происходить
        ...
        <tr id='map-wheelpxperzoomlevel'>
            ...
            <td>
                ...
                <a href="/doc/maps/ru/manual/events#domevent-getwheeldelta">DG.DomEvent.getWheelDelta</a>)
                означает изменение на один уровень масштабирования. Меньшие значения
                будут изменять масштаб карты с помощью колеса быстрее (и наоборот).
            </td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr id='map-layeradd'>
            ...
            <td><code><a href='/doc/maps/ru/manual/events#layerevent'>LayerEvent</a></code></td>
...
<table>
    ...
    <tbody>
        ...
        <tr id='map-movestart'>
            ...
            <td><code><a href='/doc/maps/ru/manual/events#event'>Event</a></code></td>
            <td>
                Вызывается при начале изменения области просмотра карты (например, когда пользователь
        ...
        <tr id='map-zoom'>
            ...
            <td><code><a href='/doc/maps/ru/manual/events#event'>Event</a></code></td>
            <td>
                Вызывается периодически в течение любого изменения уровня масштаба,
        ...
        <tr id='map-moveend'>
            ...
            <td><code><a href='/doc/maps/ru/manual/events#event'>Event</a></code></td>
            <td>
                Вызывается при окончании передвижения краты (например, когда пользователь 
        ...
        <tr id='map-langchange'>
            ...
            <td><code><a href="/doc/maps/ru/manual/events#langevent">LangEvent</a></code></td>
...
<table>
    ...
    <tbody>
        ...
        <tr id='map-autopanstart'>
            ...
            <td><code></code></td>
            <td>Вызывается, когда карта начинает двигаться после появления балуна.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr id='map-click'>
            ...
            <td>Вызывается при клике (или тапе) в карту.</td>
        </tr>
        <tr id='map-dblclick'>
            <td><code><b>dblclick</b></code></td>
            <td><code><a href='/doc/maps/ru/manual/events#mouseevent'>MouseEvent</a></code></td>
            <td>Вызывается при двойном клике (или двойном тапе) в карту.</td>
        </tr>
        <tr id='map-mousedown'>
        ...
        <tr id='map-contextmenu'>
            ...
            <td><code><a href='/doc/maps/ru/manual/events#mouseevent'>MouseEvent</a></code></td>
            <td>
                Вызывается при нажатии правой кнопки мышки на карте, предотвращает появление
        ...
        <tr id='map-keypress'>
            ...
            <td><code><a href='/doc/maps/ru/manual/events#event'>Event</a></code></td>
            <td>Вызывается нажатии клавиш на клавиатуре, когда карта находится в фокусе.</td>
        </tr>
        <tr id='map-preclick'>
            <td><code><b>preclick</b></code></td>
            <td><code><a href='/doc/maps/ru/manual/events#mouseevent'>MouseEvent</a></code></td>
            <td>
                Вызывается перед кликом мышки на карте (полезно, если нужно выполнить
...
<table>
    ...
    <tbody>
        <tr id='map-zoomanim'>
            ...
            <td><code><a href='/doc/maps/ru/manual/events#zoomanimevent'>ZoomAnimEvent</a></code></td>
            <td>Вызывается на каждый фрейм изменения масштаба.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr id='map-locationfound'>
            ...
            <td>
                Вызывается при успешном обнаружении местоположения пользователя (используется метод 
    ...
    <tbody>
        <tr id='map-getrenderer'>
            <td>
                <code>
                    <b>getRenderer</b>(
                    <nobr>&lt;<a href='/doc/maps/ru/manual/geometries#dgpath'>Path</a>&gt; <i>layer</i>)</nobr>
                </code>
            </td>
            <td><code><a href='/doc/maps/ru/manual/base-classes#dgrenderer'>Renderer</a></code></td>
            <td>
                <p>Возвращает экземпляр <a href="/doc/maps/ru/manual/base-classes#dgrenderer"><code>Renderer</code>
                </a>, который должен быть использован для отрисовки необходимого
                <a href="/doc/maps/ru/manual/geometries#dgpath"><code>Path</code></a>. Метод гарантирует, что опции
                <a href="/doc/maps/ru/manual/base-classes#dgrenderer"><code>renderer</code></a> карты и путей
                будут учитываться, и что ререндеры, действительно, существуют на карте.</p>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        <tr id='map-addlayer'>
            <td>
                <code>
                    <b>addLayer</b>(
                    <nobr>&lt;<a href='/doc/maps/ru/manual/layers#dglayer'>Layer</a>&gt; <i>layer</i>)</nobr>
                </code>
            </td>
...
<pre><code>map.eachLayer(function(layer){
    layer.bindPopup(&#39;Hello&#39;);
        ...
        <tr id='map-openpopup'>
            ...
            <td><code>this</code></td>
            <td>Создает балун с переданными опциями и содержимым и открывает его в определенной точке на карте.</td>
        </tr>
        <tr id='map-closepopup'>
            ...
            <td><code>this</code></td>
            <td>Закрывает балун, открытый с помощью <a href="/doc/maps/ru/manual/popup#map-openpopup">openPopup</a>.</td>
        </tr>
...
<table>
    ...
    <tbody>
        ...
        <tr id='map-zoomin'>
            ...
            <td><code>this</code></td>
            <td>
                Увеличивает масштаб карты на величину <code>delta</code>
        ...
        <tr id='map-zoomout'>
            ...
            <td><code>this</code></td>
            <td>
                Уменьшает масштаб карты на величину <code>delta</code>
                (по умолчанию <a href="#map-zoomdelta"><code>zoomDelta</code></a>).
            </td>
        </tr>
        ...
        <tr id='map-panto'>
            ...
            <td><code>this</code></td>
            <td>
                <p>Передвигает карту к указанному центру.</p>
            </td>
        </tr>
        <tr id='map-panby'>
            <td>
        ...
        <tr id='map-setminzoom'>
            ...
            <td><code>this</code></td>
            <td>
                <p>Устанавливает нижний предел уровней масштабирования
                (см. опцию <a href="#map-minzoom">minZoom</a>).</p>
            </td>
        </tr>
        <tr id='map-setmaxzoom'>
            ...
            <td><code>this</code></td>
            <td>
                <p>Устанавливает верхний предел уровней масштабирования
                (см. опцию <a href="#map-minzoom">maxZoom</a>).</p>
            </td>
        </tr>
        ...
        <tr id='map-invalidatesize'>
            ...
            <td>
                ...
                если размер контейнера изменяется динамически, анимация переимещения будет происходить
                по умолчанию. Если параметр <code>options.pan</code> установлен в <code>false</code>, то карта
                не будет перемещаться. Если параметр <code>options.debounceMoveend</code> установлен в
        ...
        <tr id='map-stop'>
            ...
            <td><code>this</code></td>
            <td>
                Останавливает текущие запущенные анимации <code>panTo</code> или <code>flyTo</code>.
            </td>
        </tr>
        <tr id='map-flyto'>
            <td>
            ...
            <td>
                ...
                плавную анимацию масштабирования и перемещения.
            </td>
        </tr>
        <tr id='map-flytobounds'>
            ...
            <td><code>this</code></td>
            <td>
                Устанавливает область просмотра карты с плавной анимацией масштабирования и перемещения, как
        ...
        <tr id="map-setlang">
            ...
            <td>
                Устанавливает <a href="/doc/maps/ru/manual/locale">язык карты</a>. В качестве параметра
...
<table>
    ...
    <tbody>
        <tr id='map-addhandler'>
            ...
            <td><code>this</code></td>
            <td>
                Добавляет новый <a href="/doc/maps/ru/manual/base-classes#dghandler"><code>Handler</code></a> на карту,
        ...
        <tr id='map-remove'>
            ...
            <td><code>this</code></td>
            <td><p>Уничтожает карту и удаляет все свзяанные с ней обработчики</p></td>
        </td>
        </tr>
        <tr id='map-createpane'>
            ...
            <td>
                ...
                или как ребенок главной панели карты, если <code>container</code> не установлен.
            </td>
        </tr>
        <tr id='map-getpane'>
            <td><code><b>getPane</b>(<nobr>&lt;String|HTMLElement&gt; <i>pane</i>)</nobr></code></td>
            <td><code>HTMLElement</code></td>
            <td><p>Возвращает панель карты по ее имени или по ее HTML-элементу</p></td>
        </tr>
        <tr id='map-getpanes'>
            <td><code><b>getPanes</b>()</code></td>
            <td><code>Object</code></td>
            <td>
                <p>Возвращает объект, содержащий имена всех панелей как ключи и панели как значения</p>
            </td>
        </tr>
        ...
        <tr id='map-whenready'>
            ...
            <td><code>this</code></td>
            <td>
                Выполняет функцию <code>fn</code> после инициализации карты с установленными
                центром и масштабом и по крайней мере одним слоем, или сразу, если она
...
<table>
    ...
    <tbody>
        ...
        <tr id="map-getlang">
            ...
            <td><code>String</code></td>
            <td>Возвращает текущий <a href="/doc/maps/ru/manual/locale">язык карты</a>.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr id='map-unproject'>
            ...
            <td><code><a href='/doc/maps/ru/manual/basic-types#dglatlng'>LatLng</a></code></td>
            <td><p>Метод обратный <a href="#map-project"><code>project</code></a>.</p>
            </td>
        </tr>
        <tr id='map-layerpointtolatlng'>
            ...
            <td><code><a href='/doc/maps/ru/manual/basic-types#dglatlng'>LatLng</a></code></td>
            <td>
                По переданной пиксельной координате относительно <a href="#map-getpixelorigin">origin pixel</a>
                возвращает соответствующую географическую координату (для текущего уровня масштабирования).
            </td>
        </tr>
        <tr id='map-latlngtolayerpoint'>
            ...
            <td><code><a href='/doc/maps/ru/manual/basic-types#dgpoint'>Point</a></code></td>
            <td>
                По переданной географической координате возвращает соответствующую пиксельную
                координату относительно <a href="#map-getpixelorigin">origin pixel</a>.
            </td>
        </tr>
        <tr id='map-wraplatlng'>
            ...
            <td><code><a href='/doc/maps/ru/manual/basic-types#dglatlng'>LatLng</a></code></td>
            <td>
                Возвращает <a href="/doc/maps/ru/manual/basic-types#dglatlng"><code>LatLng</code></a>, где <code>lat</code>
                ...
                образом ее значение находится между -180 и +180 градусами.
            </td>
        </tr>
        <tr id='map-distance'>
            <td>
        ...
        <tr id='map-layerpointtocontainerpoint'>
            ...
            <td><code><a href='/doc/maps/ru/manual/basic-types#dgpoint'>Point</a></code></td>
            <td>
                По переданным пиксельным координатам относительно <a href="#map-getpixelorigin">origin pixel</a>
        ...
        <tr id='map-mouseeventtocontainerpoint'>
            <td>
                <code>
                    ...
                    <nobr>&lt;<a href='#mouseevent'>MouseEvent</a>&gt; <i>ev</i>)</nobr>
                </code>
            </td>
            <td><code><a href='/doc/maps/ru/manual/basic-types#dgpoint'>Point</a></code></td>
            <td>
        ...
        <tr id='map-mouseeventtolayerpoint'>
            <td>
                <code>
                    ...
                    <nobr>&lt;<a href='/doc/maps/ru/manual/events#mouseevent'>MouseEvent</a>&gt; <i>ev</i>)</nobr>
                </code>
            </td>
            <td><code><a href='/doc/maps/ru/manual/basic-types#dgpoint'>Point</a></code></td>
            <td>
...
Свойства карты включают в себя обработчики взаимодействия, которые позволяют контролировать интерактивное поведение, подключение и отключение определенных возможностей карты, таких как перетаскивание и масштабирование тачем (см. методы [IHandler](/doc/maps/manual/interfaces#ihandler)). Например:
...
<table>
    ...
    <tbody>
        ...
        <tr id='map-geoclicker'>
            <td><code><b>geoclicker</b></code></td>
            <td><a href="/doc/maps/ru/manual/interfaces#handler"><code>Handler</code></a></td>
        ...
        <tr id='map-baseLayer'>
            ...
            <td><a href="/doc/maps/ru/manual/layers#dgtilelayer"><code>TileLayer</code></a></td>
...
Панели - это DOM-элементы, которые используются для контроля очередности слоев на карте.
...
по умолчанию есть следующий набор панелей, которые отличаются zIndex.
...
Некоторые методы геолокации объекта <a href="#map"><code>Map</code></a> принимают параметр
    ...
    <tbody>
        ...
        <tr id='locate-options-timeout'>
            ...
            <td>
                ...
                событие <code>locationerror</code>.
            </td>
        </tr>
...
Некоторые методы объекта <a href="#map"><code>Map</code></a>, которые меняют масштаб,
...
<table>
    ...
    <tbody>
        <tr id='zoom-options-animate'>
            ...
            <td><code></code></td>
            <td>
                Если не указано, тогда масштабирование будет анимироваться, если точка, относительно
                которой происходит масштабирование, находится в пределах просматриваемой области карты.
                Если <code>true</code>, тогда всегда будет производиться попытка анимировать масштабирование,
                вне зависимости от положения источника масштабирования. Если <code>false</code>,
                тогда масштабирование будет происходить без анимации.
            </td>
        </tr>
    </tbody>
</table>
...
Некоторые методы объекта <a href="#map"><code>Map</code></a>, которые меняют центр карты,
принимают параметр <code>options</code>. Это обычный JavaScript-объект со следующими
опциональными компонентами:
...
<table>
    ...
    <tbody>
        <tr id='pan-options-animate'>
            ...
            <td><code></code></td>
            <td>
                Если <code>true</code>, тогда перемещение будет всегда анимироваться. Если <code>false</code>
                перемещение не будет анимироваться при сбросе карты в исходное положение, если она была
                передвинута более чем на один экран; перемещение также не будет анимироваться при установке
        ...
        <tr id='pan-options-easelinearity'>
            ...
            <td><code>0.25</code></td>
            <td>
                Уровень искривления затухания анимации (третий параметр
                <a target="_blank" href="http://cubic-bezier.com/">Кривой Безье</a>). Значение 1.0 означает
                линейную анимацию; чем меньше значение, тем больше искривление.
            </td>
        </tr>
        <tr id='pan-options-nomovestart'>
            ...
            <td><code>false</code></td>
            <td>
                Если <code>true</code>, тогда при перемещении не будет инициироваться событие
