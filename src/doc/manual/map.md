...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>Boolean</code></td>
            <td><code>true</code></td>
            <td>Добавлен ли <a href="/doc/maps/manual/controls#класс-dgcontrolzoom">элемент управления масштабом</a> на карту.</td>
        </tr>
        <tr>
            <td><code><b>fullscreenControl</b></code></td>
            <td><code>Boolean</code></td>
            <td><code>true</code></td>
            <td>Добавлена ли <a href="/doc/maps/manual/controls#класс-dgcontrolfullscreen">кнопка включения полноэкранного режима</a> на карту.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><code><a href="/doc/maps/manual/events#resizeevent">ResizeEvent</a></code></td>
        ...
        <tr>
            ...
            <td><code><a href="/doc/maps/manual/events#locationevent">LocationEvent</a></code>
        ...
        <tr>
            ...
            <td><code><a href="/doc/maps/manual/events#errorevent">ErrorEvent</a></code>
            <td>Вызывается при возникновении ошибок во время обнаружения местоположения пользователя.</td>
        </tr>
        <tr>
            <td><code><b>popupopen</b></code></td>
            <td><code><a href="/doc/maps/manual/events#popupevent">PopupEvent</a></code>
        ...
        <tr>
            ...
            <td><code><a href="/doc/maps/manual/events#projectevent">ProjectEvent</a></code>
        ...
        <tr>
            ...
            <td><code><a href="/doc/maps/manual/events#langevent">LangEvent</a></code></td>
...
<table>
    ...
    <tbody>
        ...
        <tr id="map-setlang">
            ...
            <td>Устанавливает <a href="/doc/maps/manual/locale">язык карты</a>. В качестве параметра принимает код языка (например, 'it').</td>
        </tr>
        <tr id="map-remove">
...
<table>
    ...
    <tbody>
        ...
        <tr id="map-getlang">
            ...
            <td><code>String</code></td>
            <td>Возвращает текущий <a href="/doc/maps/manual/locale">язык карты</a>.</td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        ...
        <tr id="map-openpopup">
            <td><code><b>openPopup</b>(
                <nobr>&lt;<a href="/doc/maps/manual/popups">Popup</a>&gt; <i>popup</i> )</nobr>
            </code></td>
        ...
        <tr id="map-addcontrol">
            <td><code><b>addControl</b>(
                <nobr>&lt;<a href="/doc/maps/manual/interfaces#icontrol">IControl</a>&gt; <i>control</i> )</nobr>
            </code></td>
...
Свойства карты включают в себя обработчики взаимодействия, которые позволяют контролировать интерактивное поведение, подключение и отключение определенных возможностей карты, таких как масштабирование и тач-события (см. методы [IHandler](/doc/maps/manual/interfaces#ihandler)). Например:
...
<table>
    ...
    <tbody>
        <tr>
            <td><code><b>dragging</b></code></td>
            <td><a href="/doc/maps/manual/interfaces#ihandler"><code>IHandler</code></a></td>
