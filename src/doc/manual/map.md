...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>Boolean</code></td>
            <td><code>true</code></td>
            <td>Добавлен ли <a href="/doc/maps/2.0/manual/controls#класс-dgcontrolzoom">элемент управления масштабом</a> на карту.</td>
        </tr>
        <tr>
            <td><code><b>fullscreenControl</b></code></td>
            <td><code>Boolean</code></td>
            <td><code>true</code></td>
            <td>Добавлена ли <a href="/doc/maps/2.0/manual/controls#класс-dgcontrolfullscreen">кнопка включения полноэкранного режима</a> на карту.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><code><a href="/doc/maps/2.0/manual/events#dragendevent">DragEndEvent</a></code>
        ...
        <tr>
            ...
            <td><code><a href="/doc/maps/2.0/manual/events#event">Event</a></code></td>
        ...
        <tr>
            ...
            <td><code><a href="/doc/maps/2.0/manual/events#resizeevent">ResizeEvent</a></code></td>
        ...
        <tr>
            ...
            <td><code><a href="/doc/maps/2.0/manual/events#layerevent">LayerEvent</a></code>
            <td>Вызывается при добавлении нового слоя на карту.</td>
        </tr>
        <tr>
            <td><code><b>locationfound</b></code></td>
            <td><code><a href="/doc/maps/2.0/manual/events#locationevent">LocationEvent</a></code>
        ...
        <tr>
            ...
            <td><code><a href="/doc/maps/2.0/manual/events#errorevent">ErrorEvent</a></code>
            <td>Вызывается при возникновении ошибок во время обнаружения местоположения пользователя.</td>
        </tr>
        <tr>
            <td><code><b>popupopen</b></code></td>
            <td><code><a href="/doc/maps/2.0/manual/events#popupevent">PopupEvent</a></code>
        ...
        <tr>
            ...
            <td><code><a href="/doc/maps/2.0/manual/events#projectevent">ProjectEvent</a></code>
        ...
        <tr>
            ...
            <td><code><a href="/doc/maps/2.0/manual/events#poievent">PoiEvent</a></code>
            <td>Вызывается при наведении курсора мышки на точку интереса.</td>
        </tr>
        <tr>
            <td><code><b>poileave</b></code></td>
            <td><code><a href="/doc/maps/2.0/manual/events#poievent">PoiEvent</a></code></td>
            <td>Вызывается когда курсор мышки покидает область точки интереса.</td>
        </tr>
        <tr>
            <td><code><b>langchange</b></code></td>
            <td><code><a href="/doc/maps/2.0/manual/events#langevent">LangEvent</a></code></td>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><code>this</code></td>
            <td>Обновляет карту при изменении размера ее контейнера. Этот метод необходимо вызывать если размер контейнера изменяется динамически или карта нуждается в перерисовке (например, после отображения\скрытия родительского элемента). Если параметр <code>animate</code> установлен в <code>true</code>, тогда обновление карты анимируется.</td>
        </tr>
        ...
        <tr id="map-setlang">
            ...
            <td>Устанавливает <a href="/doc/maps/2.0/manual/locale">язык карты</a>. В качестве параметра принимает код языка (например, 'it').</td>
        </tr>
        <tr id="map-remove">
...
<table>
    ...
    <tbody>
        ...
        <tr id="map-getlang">
            ...
            <td><code>String</code></td>
            <td>Возвращает текущий <a href="/doc/maps/2.0/manual/locale">язык карты</a>.</td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        ...
        <tr id="map-openpopup">
            <td><code><b>openPopup</b>(
                <nobr>&lt;<a href="/doc/maps/2.0/manual/popups">Popup</a>&gt; <i>popup</i> )</nobr>
            </code></td>
        ...
        <tr id="map-addcontrol">
            <td><code><b>addControl</b>(
                <nobr>&lt;<a href="/doc/maps/2.0/manual/interfaces#icontrol">IControl</a>&gt; <i>control</i> )</nobr>
            </code></td>
    ...
    <tbody>
        ...
        <tr>
            <td><code><b>layerPointToLatLng</b>(
                <nobr>&lt;<a href="/doc/maps/2.0/manual/base-classes#класс-dgpoint">Point</a>&gt; <i>point</i> )</nobr>
            </code></td>
...
Свойства карты включают в себя обработчики взаимодействия, которые позволяют контролировать интерактивное поведение, подключение и отключение определенных возможностей карты, таких как масштабирование и тач-события (см. методы [IHandler](/doc/maps/2.0/manual/interfaces#ihandler)). Например:
...
<table>
    ...
    <tbody>
        <tr>
            <td><code><b>dragging</b></code></td>
            <td><a href="/doc/maps/2.0/manual/interfaces#ihandler"><code>IHandler</code></a></td>
        ...
        <tr>
            <td><code><b>zoomControl</b></code></td>
            <td><a href="/doc/maps/2.0/manual/controls#класс-dgcontrolzoom"><code>Control.Zoom</code></a></td>
            <td>Элемент управления масштабом.</td>
        </tr>
        <tr>
            <td><code><b>fullscreenControl</b></code></td>
            <td><a href="/doc/maps/2.0/manual/controls#класс-dgcontrolfullscreen"><code>Control.FullScreen</code></a></td>
