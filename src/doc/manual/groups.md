...
Используется для группировки нескольких слоев, чтобы обрабатывать их как один. Если группа добавлена на карту, тогда удалив элемент из группы он удаляется и с карты. Реализует интерфейс [ILayer](/doc/maps/2.0/manual/interfaces#ilayer).
    ...
    <tbody>
        <tr>
            <td><code><b>DG.LayerGroup</b>(
                <nobr>&lt;<a href="/doc/maps/2.0/manual/interfaces#ilayer">ILayer</a>[]&gt; <i>layers?</i> )</nobr>
            </code></td>
            <td>
    ...
    <tbody>
        ...
        <tr>
            <td><code><b>removeLayer</b>(
                <nobr>&lt;<a href="/doc/maps/2.0/manual/interfaces#ilayer">ILayer</a>&gt; <i>layer</i> | &lt;String&gt; <i>id</i> )</nobr>
            </code></td>
            <td><code>this</code></td>
...
Расширяет [LayerGroup](#класс-dglayergroup), включает в себя события мышки (инициированные членами группы) и общий метод bindPopup. Реализует интерфейс [ILayer](/doc/maps/2.0/manual/interfaces#ilayer).
    ...
    <tbody>
        ...
        <tr>
            <td><code><b>setStyle</b>(
                <nobr>&lt;<a href="/doc/maps/2.0/manual/geometries#опции">Path options</a>&gt; <i>style</i> )</nobr>
            </code></td>
            <td><code>this</code></td>
