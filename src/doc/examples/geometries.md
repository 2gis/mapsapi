...
Геометрии в АПИ карт позволяют создавать различные виды разметок и обозначений. Всевозможные виды геометрии представлены в статье. Для более подробной информации можно почитать раздел [Геометрии](/doc/2.0/maps/manual/geometries).
...
### Отображение круга и круга-маркера
...
### Геометрии с хинтоми и балунами
