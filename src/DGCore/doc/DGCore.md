...
<table>
	...
	<tr>
		...
		<td>Создает объект Marker по переданным географическим координатам и необязательному объекту с опциями.</td>
	</tr>
</table>
...
<table>
	...
	<tr id="marker-zindexoffset">
		...
		<td><code>Number</code></td>
		<td><code>0</code></td>
		<td>По умолчанию, изображению маркера свойство z-index устнавливается автоматически, исходя из его координат. Используйте эту опцию, если необходимо разместить маркер поверх (или снизу) других элементов, указав наибольшее (или наименьшее) значние.</td>
	</tr>
	<tr>
