...
Класс для отрисовки ломаных линий на карте. Расширяет [Path][17]. Для добавления на карту используется [Map\#addLayer][81].
...
Класс для отрисовки многоугольников на карте. Расширяет [Polyline][18]. Для добавления на карту используется [Map\#addLayer][81].
...
У полигона те же опции и методы, что и у ломаной.
