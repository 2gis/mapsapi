...
var gendoc = require('./docbuilder/gendoc.js');
...
var error;
var stat = {}; // files minification statistics
...
var testRequirements = isTestDebug ? [] : ['build'];
...
gulp.task('build', ['build-clean'], function (cb) {
    runSequence(
        ['build-scripts', 'build-styles', 'doc', 'copy-private-assets'],
        function () {
            if (error) {
                return;
            }
