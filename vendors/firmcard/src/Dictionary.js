...
FirmCard.prototype.dict = {
    ...
    it: {
        ...
        linkReviews: ['it отзыв', 'отзыва', 'отзывов'],
        linkPhoto: ['it фото', 'фото', 'фото'],
    ...
    en: {
        ...
        linkReviews: ['en отзыв', 'отзыва', 'отзывов'],
        linkPhoto: ['en фото', 'фото', 'фото'],
    ...
    cs: {
        ...
        linkReviews: ['cs отзыв', 'отзыва', 'отзывов'],
        linkPhoto: ['cs фото', 'фото', 'фото'],
