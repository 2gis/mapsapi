/* TODO:
    ...
    2. Автоскролл при открытии карточки
    3. Инит барона, если развернули много карточек
    4. Механизм смены языка
    5. Описать в доке методы setHeader, setFooter
    6. Пофиксить баг в FirmCard (ошибка с Forecast, двойная генерация контента)
    7. Реализовать метод toggle для графика работы
    8. Тесты FirmList
*/
