            ...
            this.all_tokens = {
                ...
                "long_decimal": {
                    "positive": {
                        ...
                        "100000": ["", "000", " тысячи"],
                        "1000000": ["", "0", " миллиона"],
                        "10000000": ["", "00", " миллиона"],
                        "100000000": ["", "000", " миллиона"],
                        "1000000000": ["", "0", " миллиарда"],
                        "10000000000": ["", "00", " миллиарда"],
                        "100000000000": ["", "000", " миллиарда"],
                        "1000000000000": ["", "0", " триллиона"],
                        "10000000000000": ["", "00", " триллиона"],
        ...
        function Bidi(options) {
            ...
            this.bidi_classes = {
                ...
                "L": {
                    ...
                    "38": [1377, 119040],
                    "54": [2307],
                    "9": [2392, 2662, 3114, 3174, 3242, 3302, 3792, 3902, 6112, 6160, 6784, 6800, 8458, 43000, 43250, 43600, 44016, 66720, 69734, 69872, 70079, 70096, 71360],
