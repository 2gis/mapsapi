...
Типичная файловая структура модуля:
...
Снабжайте модули тестами, это позволит упростить их поддержку в будущем. В качестве тестового фреймворка в API карт используется [Mocha](http://visionmedia.github.io/mocha/).
...
Составьте текст лицензии, ведь это неотъемлемая часть любого open-source проекта.
