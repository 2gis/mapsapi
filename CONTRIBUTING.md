...
И сформировать файловую структуру:
    ...
    /src   &mdash; исходные JS файлы
    /demo  &mdash; HTML файлы с примерами использования 
    /dist  &mdash; минифицированные JS и CSS файлы, а также изображения
    README.md
    LICENSE.md
...
Рекомендуемая файловая структура модуля:
    ...
    /src       &mdash; исходные JS файлы
    /doc       &mdash; документация
    /lang      &mdash; языковые файлы
    /skin      &mdash; изображения и CSS файлы разных тем API карт
    /templates &mdash; шаблоны
    /test      &mdash; тесты
    /demo      &mdash; HTML файлы с примерами использования 
    /dist      &mdash; минифицированные JS и CSS файлы, а также изображения
    README.md
