...
class Ruler(MapsAPIBaseTest):
    ...
    def ruler_vertex_in_middle(self):
        ...
        6.Проверяем что узел добавился в серидину
        """
        pass
    ...
    def ruler_delete_middle_in_many(self):
        ...
        8.Проверяем длинну в маркере 2 вершины
        """
        pass
    ...
    def ruler_drag_first(self):
        ...
        6.Проверяем что переместился нужный узел
        7.Проверяем значения длинны в последнем
        8.Проверяем значение длинны в первом на 0
        """
        pass
