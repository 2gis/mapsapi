...
Чтобы начать использовать API карт нужно получить ключ, для этого обратитесь api@2gis.com, далее перейдите в раздел [Быстрый старт](http://api.2gis.ru/doc/maps/ru/quickstart/).
